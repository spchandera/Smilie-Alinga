...
class HeaderMenu extends Component {
  ...
  #deactivate = (item = this.#state.activeItem) => {
    ...
    // Don't deactivate if the overflow menu, overflow list, or active submenu is still being hovered
    if (this.overflowListHovered || this.overflowMenu?.matches(':hover') || submenu?.matches(':hover')) return;
